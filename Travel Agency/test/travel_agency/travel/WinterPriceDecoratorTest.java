...
public class WinterPriceDecoratorTest {

	private WinterPriceDecorator wpDec;
	...
	public void setUp() throws NoMoreAvailablePlacesException, NotEnoughMoneyException {
		...
		wpDec = new WinterPriceDecorator(travelAd);
		
	}
	
	@Test
	public void testCalculatePrice() {
		assertEquals(85, wpDec.calculatePrice(), EPSILON);
	}

	@Test
	public void testApplyWinterSale() {
		assertEquals(85, wpDec.applyWinterSale(travelAd.calculatePrice()), EPSILON);
	}
}
