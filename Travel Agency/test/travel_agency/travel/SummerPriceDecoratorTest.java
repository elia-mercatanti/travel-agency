...
public class SummerPriceDecoratorTest {

	private SummerPriceDecorator supDec;
	...
	public void setUp() throws NoMoreAvailablePlacesException, NotEnoughMoneyException {
		...
		supDec = new SummerPriceDecorator(travelAd);
		
	}
	
	@Test
	public void testCalculatePrice() {
		assertEquals(95, supDec.calculatePrice(), EPSILON);
	}

	@Test
	public void testApplyWinterSale() {
		assertEquals(95, supDec.applySummerSale(travelAd.calculatePrice()), EPSILON);
	}
}
