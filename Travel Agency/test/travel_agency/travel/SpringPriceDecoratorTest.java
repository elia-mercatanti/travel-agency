...
public class SpringPriceDecoratorTest {

	private SpringPriceDecorator spDec;
	...
	public void setUp() throws NoMoreAvailablePlacesException, NotEnoughMoneyException {
		...
		spDec = new SpringPriceDecorator(travelAd);
		
	}
	
	@Test
	public void testCalculatePrice() {
		assertEquals(90, spDec.calculatePrice(), EPSILON);
	}

	@Test
	public void testApplyWinterSale() {
		assertEquals(90, spDec.applySpringSale(travelAd.calculatePrice()), EPSILON);
	}
}
